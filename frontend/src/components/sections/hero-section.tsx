        ...
        <div className="absolute inset-0 [perspective:1000px]">
          <motion.div 
            ...
            style={{ 
              ...
              // Linear-gradient opacity mask to fadeRecede gracefully
            ...
            <div className="flex items-center justify-center lg:justify-end gap-10">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="absolute top-8 left-8 flex flex-col gap-3">
                    <div className="px-4 py-2 rounded-full bg-black/60 backdrop-blur-md border border-[#00FF66]/30 shadow-[0_0_15px_rgba(0,255,102,0.2)] text-[10px] text-[#00FF66] font-black uppercase flex items-center gap-2">
              ...
              <div className="flex flex-col gap-6 w-60">
                ...
                <motion.div 
                  ...
                  className="bg-[#00FF66]/10 backdrop-blur-3xl p-8 rounded-[2.5rem] border border-[#00FF66]/20 shadow-[0_20px_50px_rgba(0,255,102,0.1)]"
                >
