...
export function HolographicCard() {
  return (
    <motion.div
      ...
      className="relative z-50 flex flex-col justify-between rounded-[24px] p-10 shadow-[0_40px_100px_rgba(0,0,0,0.6)] overflow-hidden cursor-default group border border-white/20"
      style={{
        width: "480px",
        height: "300px",
